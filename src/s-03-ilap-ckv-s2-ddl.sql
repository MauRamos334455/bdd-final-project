...
-- 
-- TABLE: "HISTORICO_STATUS_LAPTOP_F2_CKV_S2" 
--

CREATE TABLE HISTORICO_STATUS_LAPTOP_F2_CKV_S2(
...
CREATE TABLE SUCURSAL_F2_CKV_S2(
    ...
    CONSTRAINT SUCURSAL_CHK CHECK (
        (SUBSTR(CLAVE, 3,2) = 'EA' AND ES_VENTA = 1 AND ES_TALLER = 0) OR
        (SUBSTR(CLAVE, 3,2) = 'EA' AND ES_VENTA = 0 AND ES_TALLER = 1)
      )
)
;
