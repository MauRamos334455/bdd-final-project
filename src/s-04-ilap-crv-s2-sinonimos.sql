...
create or replace laptop_inventario_f4 for laptop_inventario_f4_crv_s2;
...
create or replace historico_status_f4 for historico_status_f4_crv_s2;
...
create or replace tipo_monitor_r3 for tipo_monitor_crv_s1@crvbdd_s1;
create or replace tipo_monitor_r4 for tipo_monitor_crv_s2;
...
create or replace tipo_almacenamiento_r3 for tipo_almacenamiento_crv_s1@crvbdd_s1;
create or replace tipo_almacenamiento_r4 for tipo_almacenamiento_crv_s2;
...
create or replace tipo_procesador_r3 for tipo_procesador_crv_s1@crvbdd_s1;
create or replace tipo_procesador_r4 for tipo_procesador_crv_s2;
...
create or replace tipo_tarjeta_video_r3 for tipo_tarjeta_video_crv_s1@crvbdd_s1;
create or replace tipo_tarjeta_video_r4 for tipo_tarjeta_video_crv_s2;
