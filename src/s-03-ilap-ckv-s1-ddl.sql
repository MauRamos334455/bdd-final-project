...
-- @Descripción: DDL para el sitio CKV_S1
...
CREATE TABLE LAPTOP_INVENTARIO_F1_CKV_S1(
    ...
    STATUS_LAPTOP_ID    NUMBER(5, 0)     NOT NULL,
    CONSTRAINT LAPTOP_ID_PK PRIMARY KEY (LAPTOP_ID), 
    CONSTRAINT LAPTOP_INVENTARIO_STATUS_ID_FK FOREIGN KEY (STATUS_LAPTOP_ID)
...
-- 
-- TABLE: historico_status_laptop_LAPTOP_F1_CKV_S1 
--

CREATE TABLE HISTORICO_STATUS_LAPTOP_F1_CKV_S1(
    HISTORICO_STATUS_LAPTOP_ID    NUMBER(10, 0)    NOT NULL,
    LAPTOP_ID             NUMBER(10, 0)    NOT NULL,
    FECHA_STATUS          TIMESTAMP(6)     NOT NULL,
    STATUS_LAPTOP_ID      NUMBER(5, 0)     NOT NULL,
    CONSTRAINT H_STATUS_LAPTOP_PK PRIMARY KEY (HISTORICO_STATUS_LAPTOP_ID), 
    CONSTRAINT H_STATUS_LAPTOP_STATUS_ID_FK FOREIGN KEY (STATUS_LAPTOP_ID)
    REFERENCES STATUS_LAPTOP(STATUS_LAPTOP_ID),
    CONSTRAINT H_STATUS_LAPTOP_LAPTOP_ID_FK FOREIGN KEY (LAPTOP_ID)
...
CREATE TABLE SUCURSAL_F1_CKV_S1(
    ...
    CONSTRAINT SUCURSAL_CHK CHECK (
        (SUBSTR(CLAVE, 3,2) = 'NO' AND ES_VENTA = 1 AND ES_TALLER = 0) OR
        (SUBSTR(CLAVE, 3,2) = 'NO' AND ES_VENTA = 0 AND ES_TALLER = 1) OR
        (SUBSTR(CLAVE, 3,2) IN ('EA', 'SO', 'WS') AND ES_VENTA = 1 AND ES_TALLER = 1 AND)
      )
)
;
