...
-- Company :      UNAM
-- Project :      relacional-crv-s1.DM1
-- Author :       mauri33445@live.com.mx
--
-- Date Created : Thursday, January 06, 2022 20:37:41
...
CREATE TABLE LAPTOP_F3_CRV_S1(
    ...
    CONSTRAINT RefTIPO_ALMACENAMIENTO_R_CRV_9 FOREIGN KEY (TIPO_ALMACENAMIENTO_ID)
    REFERENCES TIPO_ALMACENAMIENTO_R_CRV_S1(TIPO_ALMACENAMIENTO_ID),
    CONSTRAINT RefTIPO_MONITOR_R_CRV_S110 FOREIGN KEY (TIPO_MONITOR_ID)
    REFERENCES TIPO_MONITOR_R_CRV_S1(TIPO_MONITOR_ID),
    CONSTRAINT RefTIPO_PROCESADOR_R_CRV_S111 FOREIGN KEY (TIPO_PROCESADOR_ID)
    REFERENCES TIPO_PROCESADOR_R_CRV_S1(TIPO_PROCESADOR_ID),
    CONSTRAINT RefTIPO_TARJETA_VIDEO_R_CRV_12 FOREIGN KEY (TIPO_TARJETA_VIDEO_ID)
...
-- 
-- TABLE: LAPTOP_INVENTARIO_F3_CRV_S1 
--

CREATE TABLE LAPTOP_INVENTARIO_F3_CRV_S1(
    LAPTOP_ID      NUMBER(10, 0)    NOT NULL,
...
CREATE TABLE SUCURSAL_TALLER_F3_CRV_S1(
    ...
    CONSTRAINT RefSUCURSAL_F3_CRV_S11 FOREIGN KEY (SUCURSAL_ID)
...
CREATE TABLE SERVICIO_LAPTOP_F3_CRV_S1(
    ...
    CONSTRAINT RefSUCURSAL_TALLER_F3_CRV_S18 FOREIGN KEY (SUCURSAL_ID)
...
CREATE TABLE SUCURSAL_VENTA_F3_CRV_S1(
    ...
    CONSTRAINT RefSUCURSAL_F3_CRV_S12 FOREIGN KEY (SUCURSAL_ID)
    REFERENCES SUCURSAL_F3_CRV_S1(SUCURSAL_ID)
)
;
