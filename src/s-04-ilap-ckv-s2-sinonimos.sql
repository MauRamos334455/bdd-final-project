...
create or replace synonym historico_status_laptop_f1 for historico_status_LAPTOP_F1_CKV_S1@ckvbdd_s1;
create or replace synonym historico_status_laptop_f2 for historico_status_LAPTOP_F2_CKV_S2;

create or replace synonym tipo_monitor_r1 for tipo_monitor_r_ckv_s2;
...
create or replace synonym tipo_almacenamiento_r1 for tipo_almacenamiento_r_ckv_s2;
...
create or replace synonym tipo_procesador_r1 for tipo_procesador_r_ckv_s2;
...
create or replace synonym tipo_tarjeta_video_r1 for tipo_tarjeta_video_r_ckv_s2;
