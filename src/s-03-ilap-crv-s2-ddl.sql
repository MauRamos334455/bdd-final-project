...
-- @Descripción: DDL para el sitio CRV_S2
...
CREATE TABLE SUCURSAL_F4_CRV_S2(
    ...
    CONSTRAINT SUCURSAL_CHK CHECK (
      (SUBSTR(CLAVE, 3,2) = 'SO' AND ES_VENTA = 1 AND ES_TALLER = 0) OR
      (SUBSTR(CLAVE, 3,2) = 'SO' AND ES_VENTA = 0 AND ES_TALLER = 1)
    )
)
;
...
CREATE TABLE SERVICIO_LAPTOP_F4_CRV_S2(
    ...
    CONSTRAINT SERVICIO_LAPTOP_LAPTOP_ID_FK FOREIGN KEY (LAPTOP_ID)
