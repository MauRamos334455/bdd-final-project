...
begin
  case
    ...
    if fecha_status > to_date('2009-12-31','yyyy-mm-dd') then 
        insert into historico_status_f1(historico_status_laptop_id, fecha_status,status_laptop_id,laptop_id)
        ...
        insert into historico_status_f2(historico_status_laptop_id, fecha_status,status_laptop_id,laptop_id)
        values(:new.historico_status_laptop_id, :new.fecha_status, :new.status_laptop_id, :new.laptop_id);
    else
    ...
    when deleting then
    if fecha_status > to_date('2009-12-31','yyyy-mm-dd') then 
        delete from historico_status_f1 where historico_status_laptop_id = :old.historico_status_laptop_id; 
    elsif fecha_status <= to_date('2009-12-31','yyyy-mm-dd') then 
        delete from historico_status_f2 where historico_status_laptop_id = :old.historico_status_laptop_id;   
    else
        raise_application_error(-20010,
          'Valor incorrecto para la fecha status');
    end if;
